<template>
    ...
    <Slide v-for="item in movies?.results" :key="item" class="mt-4 pb-4 pt-0">
...
export default{
    ...
    methods: {
        fetchDatas() {
            axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=a348e7136197bd5186dd097b93931f79&language=${this.getLang}`)
           .then(response => {
